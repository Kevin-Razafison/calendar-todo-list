...
class AppColors {
  ...
  static const Color boardWhite         = Color(0xFFF5F3EE);
  static const Color boardGrid          = Color(0xFFDDDAD3);
  static const Color boardShadow        = Color(0x33000000);
  ...
  static const Color textMedium         = Color(0xFF4A3728);
  static const Color textLight          = Color(0xFF8B7355);
  static const Color textOnSticky       = Color(0xFF2C1A00);
  static const Color textMonthTitle     = Color(0xFF1A1008);
  
  //Jours spéciaux
  static const Color sundayRed          = Color(0xFFC62828);
  static const Color todayAccent        = Color(0xFF4A90D9);
  static const Color todayFill          = Color(0x1A4A90D9);
  
  //UI Général
  static const Color fabBackground      = Color(0xFF683A1F);
